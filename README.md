gdocs2md
========
This is a fork of the original gdocs2md script by Renato Mangini.
...
## Usage
  ...
  * Adding this script to your doc (once per doc):
    ...
    * Clear the myFunction() default empty function and paste the contents of [converttomarkdown.gs](https://raw.githubusercontent.com/gjdickens/gdocs2md/master/converttomarkdown.gs) into the code editor
    * File -> Save
  ...
  * Running the script (run as many times as you want):
    ...
    - Converted doc with images attached can emailed to you. Subject will be "[MARKDOWN_MAKER]...".
    - **UPDATED**: Option to save doc directly to your Google Drive


## Interpreted formats
  * Text:
    * paragraphs are separated by two newlines
    * **UPDATED**: formatting for strikethrough text
  ...
  * Blocks:
    ...
    * Tables:
      * **UPDATED**: Simple table formatting `Header 1 | Header 2 `
...
Original script is maintained by:
...
* GJ Dickens - [Github](//github.com/gjdickens)
